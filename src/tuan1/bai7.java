...
public class bai7 {
  public static void main(String[] args)
  {
      ...
      checkPerfectSquare(a,n); 
        ...
        public static void checkPerfectSquare(int a[],int n)
        { double sq = Math.sqrt(n); if ((sq - Math.floor(sq)) == 0)
            System.out.println(" Là số chính phương");
        else System.out.println(" Không phải là số chính phương"); 
        }
}
