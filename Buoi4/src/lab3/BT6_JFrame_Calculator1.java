 ...
 * @author ADM
 */
public class BT6_JFrame_Calculator1 extends javax.swing.JFrame {

    /**
     * Creates new form JFrame_BT6
     */
    public BT6_JFrame_Calculator1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BT6_JFrame_Calculator1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BT6_JFrame_Calculator1().setVisible(true);
            }
        });
    }
